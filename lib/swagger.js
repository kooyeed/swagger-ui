...
(function() {
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops, consumes, produces) {
      ...
      if (ops) {
        ...
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          ...
          op = new SwaggerOperation(o.nickname, resource_path, method, o.parameters, o.summary, o.notes, type, responseMessages, this, consumes, produces, o.reviser, o.revisionDesc, o.updateTime, o.paramType, o.percent);
  ...
  SwaggerOperation = (function() {    
    function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces, reviser, revisionDesc, updateTime, paramType, percent) {
